...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_content'])) {
    ...
    $ideal_for = isset($_POST['ideal_for']) ? implode(', ', $_POST['ideal_for']) : '';
...
<body class="bg-gradient-to-br from-pink-200 via-purple-200 to-blue-300 min-h-screen flex flex-col">
    ...
    <main class="container mx-auto flex-grow flex flex-col md:flex-row mt-8">
        <nav class="bg-white shadow-lg rounded-lg p-4 w-full md:w-1/4 mb-6 md:mb-0">
            <ul class="space-y-4">
                <li><a href="?type=cafe" class="block bg-pink-400 text-white py-2 px-4 rounded-lg text-center hover:bg-pink-500">Manage Cafes</a></li>
                <li><a href="?type=restaurant" class="block bg-purple-400 text-white py-2 px-4 rounded-lg text-center hover:bg-purple-500">Manage Restaurants</a></li>
                <li><a href="logout.php" class="block bg-red-400 text-white py-2 px-4 rounded-lg text-center hover:bg-red-500">Logout</a></li>
            </ul>
        </nav>
